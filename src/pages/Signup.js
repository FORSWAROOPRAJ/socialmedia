...
function Signup() {
    ...
    const uploadProfilePicture = () => {
        ...
        formData.append("upload_preset", "socialmediainsta");
        formData.append("cloud_name", "socialmediainsta ");

        fetch("https://api.cloudinary.com/v1_1/socialmediainsta/image/upload", {
            method: "post",
            body: formData
